...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description='Abuse/Random Insult generator',
    ...
    parser.add_argument('-a',
                        '--adjectives',
                        help='Number of adjectives in insult',
                        metavar='int',
                        type=int,
                        default=2)
    ...
    parser.add_argument('-s',
                        '--seed',
                        help='Place to start/Random seed',
                        metavar='int',
                        type=int,
                        default=None)
...
def main():
    ...
    for index in range(args.number):
        print('You {} {}!'.format(', '.join(random.sample(adjectives, k=args.adjectives)), random.choice(nouns)))
